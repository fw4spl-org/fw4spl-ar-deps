...
set(VLFEAT_PATCH_CMD "${PATCH_EXECUTABLE}" -p1 -i ${VLFEAT_PATCH_DIR}/AddedVC2013.diff -d <SOURCE_DIR> 
    COMMAND "${PATCH_EXECUTABLE}" -p1 -i ${VLFEAT_PATCH_DIR}/ConditionalMex.diff -d <SOURCE_DIR>
    )
...
ExternalProject_Add(
    ...
    DOWNLOAD_NAME vlfeat-0.9.20.tar.gz
    BUILD_IN_SOURCE 1
    CONFIGURE_COMMAND ""
    PATCH_COMMAND ${VLFEAT_PATCH_CMD}
    BUILD_COMMAND ${MAKE} -f <SOURCE_DIR>/Makefile.mak MEX="" DEBUG=${DEBUG} INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}    
    INSTALL_COMMAND ${CMAKE_COMMAND} -P ${CMAKE_CURRENT_BINARY_DIR}/CopyFiles.cmake
#    STEP_TARGETS CopyFiles CopyConfigFileToInstall    
